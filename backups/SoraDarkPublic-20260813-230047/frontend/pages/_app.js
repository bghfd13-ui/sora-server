...
function RobloxApp({Component, pageProps}) {
    ...
    useEffect(() => {
        ...
        //   const divBackground = theme === themeType.obc2016 ? 'url(/img/Unofficial/obc_theme_2016_bg.png) repeat-x #222224' : isChristmas ? 'url(/img/holiday/blue-snow.png) repeat' : (document.getElementById('theme-2016-enabled') || document.getElementById('theme-2021-enabled')) ? 'var(--background-color)' : 'var(--white-color)';
        ...
        if (el && el.length) {
            ...
            const divBackground =
                ...
                :
                (document.getElementById('theme-2016-enabled') || document.getElementById('theme-2021-enabled'))
                ?
                '#e3e3e3'
                :
                '#fff'
    ...
    return <div style={pageProps.disableWebsiteTheming ? {minHeight: '100vh'} : null}>
        <Head>
            ...
            <title>{pageProps.title || 'Sora'}</title>
